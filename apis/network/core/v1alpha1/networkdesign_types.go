...
type NetworkDesignSpec struct {
	...
	Interfaces *NetworkDesignInterfaces `json:"interfaces,omitempty" protobuf:"bytes,1,rep,name=interfaces"`
	// Protocols define the network wide protocol parameters
	Protocols *NetworkDesignProtocols `json:"protocols,omitempty" protobuf:"bytes,2,opt,name=protocols"`
	// Encapsultation define the encapsulation parameters
	Encapsultation *NetworkDesignEncapsulation `json:"encapsulation,omitempty" protobuf:"bytes,3,opt,name=encapsulation"`
}

type NetworkDesignInterfaces struct {
	Loopback *NetworkDesignInterfacesLoopback `json:"loopback,omitempty" protobuf:"bytes,1,opt,name=loopback"`
	Underlay *NetworkDesignInterfacesUnderlay `json:"underlay,omitempty" protobuf:"bytes,2,opt,name=underlay"`
}

type NetworkDesignInterfacesLoopback struct {
	NetworkDesignInterfaceParameters `json:",inline" protobuf:"bytes,1,opt,name=parameters"`
}

type NetworkDesignInterfacesUnderlay struct {
	NetworkDesignInterfaceParameters `json:",inline" protobuf:"bytes,1,opt,name=parameters"`
	// VLANTagging defines if VLAN tagging should be used or not
	VLANTagging bool `json:"vlanTagging,omitempty" protobuf:"bytes,2,opt,name=vlanTagging"`
	// BFD defines the bfd parameters on the interface
	BFD *BFDLinkParameters `json:"bfd,omitempty" protobuf:"bytes,3,opt,name=bfd"`
}
...
type NetworkDesignInterfaceParameters struct {
	...
	Prefixes []ipambev1alpha1.Prefix `json:"prefixes,omitempty" protobuf:"bytes,1,rep,name=prefixes"`
	...
	Addressing Addressing `json:"addressing,omitempty" protobuf:"bytes,2,opt,name=addressing"`
...
type NetworkDesignEncapsulation struct {
	VXLAN *NetworkDesignEncapsulationVXLAN `json:"vxlan,omitempty" protobuf:"bytes,1,opt,name=vxlan"`
	MPLS  *NetworkDesignEncapsulationMPLS  `json:"mpls,omitempty" protobuf:"bytes,2,opt,name=mpls"`
	SRV6  *NetworkDesignEncapsulationSRv6  `json:"srv6,omitempty" protobuf:"bytes,3,opt,name=srv6"`
}
...
type NetworkDesignEncapsulationMPLS struct {
	LDP  *NetworkDesignEncapsulationMPLSLDP  `json:"ldp,omitempty" protobuf:"bytes,1,opt,name=ldp"`
	SR   *NetworkDesignEncapsulationMPLSSR   `json:"sr,omitempty" protobuf:"bytes,2,opt,name=sr"`
	RSVP *NetworkDesignEncapsulationMPLSRSVP `json:"rsvp,omitempty" protobuf:"bytes,3,opt,name=rsvp"`
}
...
type NetworkDesignEncapsulationSRv6 struct {
	MicroSID *NetworkDesignEncapsulationMPLSSRv6MicroSID `json:"ldp,omitempty" protobuf:"bytes,1,opt,name=ldp"`
}
...
type NetworkDesignProtocolsOSPF struct {
	...
	Version OSPFVersion `json:"version" protobuf:"bytes,2,opt,name=version"`
	// Area defines the default area used if not further refined on the interface.
	Area string `json:"area" protobuf:"bytes,3,opt,name=area"`
	// MaxECMPPaths defines the maximum ecmp paths used in OSPF
	// +kubebuilder:validation:Maximum=64
	// +kubebuilder:validation:Minimum=1
	// +kubebuilder:default=1
	MaxECMPPaths *uint32 `json:"maxECMPPaths,omitempty" protobuf:"bytes,4,opt,name=maxECMPPaths"`
	// BFD defines if BFD is enabled globally on OSPF
	BFD bool `json:"bfd,omitempty" protobuf:"bytes,5,opt,name=bfd"`
}
type NetworkDesignProtocolsISIS struct {
	...
	Level ISISLevel `json:"level,omitempty" protobuf:"bytes,2,opt,name=level"`
	// Areas defines the ISIS areas
	Areas []string `json:"areas" protobuf:"bytes,3,rep,name=areas"`
	// MaxECMPPaths defines the maximum ecmp paths used in OSPF
	// +kubebuilder:validation:Maximum=64
	// +kubebuilder:validation:Minimum=1
	// +kubebuilder:default=1
...
type NetworkDesignProtocolsIBGP struct {
	AS              *uint32  `json:"as,omitempty" protobuf:"bytes,1,opt,name=as"`
	LocalAS         bool     `json:"localAS,omitempty" protobuf:"bytes,2,opt,name=localAS"`
	RouteReflectors []string `json:"routeReflectors,omitempty" protobuf:"bytes,3,opt,name=routeReflectors"`
}

type NetworkDesignProtocolsEBGP struct {
	ASPool *string `json:"asPool,omitempty" protobuf:"bytes,1,opt,name=asPool"`
	// BFD defines if BFD is enabled globally on EBGP
	BFD bool `json:"bfd,omitempty" protobuf:"bytes,2,opt,name=bfd"`
}
...
type NetworkDesignList struct {
	...
	Items           []NetworkDesign `json:"items" protobuf:"bytes,2,rep,name=items"`
}
